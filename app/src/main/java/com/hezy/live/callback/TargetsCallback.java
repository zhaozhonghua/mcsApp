...
import com.hezy.live.entity.Targets;

/**
 * Created by whatisjava on 15/11/11.
 */
public class TargetsCallback extends BaseCallback {

    protected void onSuccess(Targets targets) {
    }
    ...
    protected void onSuccess(JSONObject jsonObject) {
        if (jsonObject.containsKey("errcode")) {
            ...
            if (code == 0) {
                onSuccess(JSON.parseObject(jsonObject.toString(), Targets.class));
            } else {
